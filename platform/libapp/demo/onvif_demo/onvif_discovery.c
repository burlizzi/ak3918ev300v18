		...
		if ((r = recvfrom(fd, buf, MAXBUF, 0, 
			...
			if (find_str_from_buf (buf, buflen, ":NetworkVideoTransmitter",
				...
				sprintf(buf1, "%s%s<env:Header><wsadis:MessageID>urn:uuid:%s"
						...
						"H.265_IPCamera onvif://www.onvif.org/Profile/Streaming"
				...
				sprintf(buf1, "%s%s<env:Header><wsadis:MessageID>urn:uuid:%s"
						...
						"onvif://www.onvif.org/name/H.265_IPCamera onvif://"
				...
				sprintf(buf1, "%s%s<env:Header><wsadis:MessageID>urn:uuid:%s"
						...
						"www.onvif.org/name/H.265_IPCamera onvif://www.onvif.org/"
